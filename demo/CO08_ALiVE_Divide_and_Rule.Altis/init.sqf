...
if (hasInterface) then {
	...
	player createDiaryRecord ["Diary", ["Dismantle the device", 
		"INTEL has been received about a nuclear device beeing build in an hideout in Zaros, centre of terrorist activities on Lemnos! The iranian contact is said to be an officer named Ahelef Mahmoud, very likely to be located near the device! Objective is to question Mahmoud, disable the bomb, and return home safely!"
	]];
	...
	titleText ["A L i V E   |   DIvIDE  &  RULE", "BLACK IN",10];
