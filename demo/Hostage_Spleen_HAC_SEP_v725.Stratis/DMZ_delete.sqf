...
_groupDel = false;  	// if empty groups should be deleted, to avoid reaching 144 group limit in long missions.
_viewDist = 450;  		// min distance in meter from a player unit to allow delete, if you dont care if player sees the delete, set it to 0.
_manTimer = 240;  		// x seconds until delete of dead man units.
_vehTimer = 480;  		// x seconds until delete of dead vehicles, for destroyed and heavy damaged vehicles.
