...
==================================================================================================================
  ...
  Like this:
  veh = [this, 15, 10, 5, TRUE, FALSE, "_this setDammage 0.5"] execVM "vehicle.sqf"
  
  Default values of all settings are:
  veh = [this, 300, 0, 0, FALSE, FALSE] execVM "vehicle.sqf"
...
{	
	...
	{	
		...
		if (_haveinit) then {
			...
			[call compile format["%1",_sCommand], "BIS_fnc_spawn", nil, true] spawn BIS_fnc_MP;
		};
		if (_hasname) then {
