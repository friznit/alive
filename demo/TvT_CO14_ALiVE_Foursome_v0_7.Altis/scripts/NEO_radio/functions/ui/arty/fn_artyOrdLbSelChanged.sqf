...
{
	//Texts
	_artyRateOfFireText ctrlSetStructuredText parseText "<t color='#FFFF00' size='0.5' font='Zeppelin33Italic'>RATE OF FIRE</t>";
	_artyRoundCountText ctrlSetStructuredText parseText "<t color='#FFFF00' size='0.5' font='Zeppelin33Italic'>ROUND COUNT</t>";
	_artyDispersionText ctrlSetStructuredText parseText "<t color='#FFFF00' size='0.5' font='Zeppelin33Italic'>DISPERSION - 0/500m</t>";
	...
	//Slider
	_artyDispersionSlider ctrlSetPosition [safeZoneX + (safeZoneW / 2.225), safeZoneY + (safeZoneH / 1.65), (safeZoneW / 11), (safeZoneH / 75)];
