...
rem ----------------------------- User ------------------------------------
%exe% "%arma%\@a2co\@smd_sahrani_a2\addons\smd_sahrani_a2.pbo" > %target%\objects.smd_sahrani_a2.sqf
%exe% "%arma%\@a2co\@MBG_Celle2\addons\mbg_celle2.pbo" > %target%\objects.mbg_celle2.sqf
