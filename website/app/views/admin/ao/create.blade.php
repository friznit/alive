                    ...
                    <form action="{{ URL::to('admin/ao/create') }}" method="post">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group {{ ($errors->has('size')) ? 'has-error' : '' }}" for="size">
                                ...
                                <input name="size" value="{{ Request::old("size") }}" type="text" class="form-control" placeholder="Size">
                                <?php
                                if($errors->has('size')){
                            ...
                            <div class="form-group {{ ($errors->has('imageMapX')) ? 'has-error' : '' }}" for="imageMapX">
                                ...
                                <input name="imageMapX" value="{{ Request::old("imageMapX") }}" type="text" class="form-control" placeholder="imageMapX">
                                <?php
                            ...
                            <div class="form-group {{ ($errors->has('imageMapY')) ? 'has-error' : '' }}" for="imageMapY">
                                ...
                                <input name="imageMapY" value="{{ Request::old("imageMapY") }}" type="text" class="form-control" placeholder="imageMapY">
                                <?php
