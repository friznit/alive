...
switch(_operation) do {
	...
	if (isServer) then {
	    ...
	    _debug = [_logic, "debug"] call MAINCLASS;
			...
			[_logic, _debug] spawn {
		private ["_minSkill","_maxSkill","_diff","_factionSkill","_faction","_aimingAccuracy","_aimingShake","_aimingSpeed","_logic","_debug","_skillFactionsRecruit","_skillFactionsRegular","_skillFactionsVeteran","_skillFactionsExpert","_customSkillFactions","_customSkillAbilityMin","_customSkillAbilityMax","_customSkillAimAccuracy","_customSkillAimShake","_customSkillAimSpeed","_customSkillEndurance","_customSkillSpotDistance","_customSkillSpotTime","_customSkillCourage","_customSkillReload","_customSkillCommanding","_customSkillGeneral","_recruitSkill","_regularSkill","_veteranSkill","_expertSkill","_customSkill","_factionSkills"];
