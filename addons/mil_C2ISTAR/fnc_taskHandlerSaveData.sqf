...
[true, "ALiVE Task Handler persistence save data started", "taskHandlerper"] call ALIVE_fnc_timer;
...
[false, "ALiVE Task Handler persistence save data complete","taskHandlerper"] call ALIVE_fnc_timer;
