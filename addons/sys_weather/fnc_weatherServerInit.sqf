             ...
             _options = [0,1,2,3];
		         ...
		         switch (INITIAL_WEATHER) do
				        	...
				        	if (_currentmonth >=4 && _currentmonth <=9) then {  // Summer ( April through May, June, July, August and September)
								...
								case 5: { 
									  _realWeatherHash = [WEATHER_CYCLE_REAL_DATE,WEATHER_CYCLE_REAL_LOCATION] call ALIVE_fnc_getWeather;
								
									};  // Real Weather - Real weather for a time and location you specifiy.
