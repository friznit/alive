...
if ((_ammo > 0) and not (_busy)) then
	...
	if ((_logic getvariable "HAC_HQ_Debug") or (isPlayer (leader _unitG))) then 
		{
		_i1 = [[_posXWP1,_posYWP1],_unitG,"markFlank1","ColorOrange","ICON","mil_dot","Fl1 A"," - FLANK 1",_logic] call ALiVE_fnc_HAC_Mark;
		_i2 = [[_posXWP2,_posYWP2],_unitG,"markFlank2","ColorOrange","ICON","mil_dot","Fl2 A"," - FLANK 2",_logic] call ALiVE_fnc_HAC_Mark;
		_i3 = [[_posXWP3,_posYWP3],_unitG,"markFlank3","ColorOrange","ICON","mil_dot","Fl3 A"," - FLANK 3",_logic] call ALiVE_fnc_HAC_Mark;
		_i4 = [[_posXWP4,_posYWP4],_unitG,"markFlank4","ColorOrange","ICON","mil_dot","Fl4 A"," - FLANKING ATTACK",_logic] call ALiVE_fnc_HAC_Mark
		};
