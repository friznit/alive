private ["_logic","_rnd","_gauss","_gauss1","_hqmatt"];
_logic = _this select 0;
if (isNil {_logic getvariable "HAC_HQ_MAtt"}) then {_logic setvariable ["HAC_HQ_MAtt", false]};
_hqmatt = _logic getvariable "HAC_HQ_MAtt";
if ((isNil {_logic getvariable "HAC_HQ_Personality"}) or not ((_hqmatt))) then {_logic setvariable ["HAC_HQ_Personality", "OTHER"]};
