...
SCRIPT(getSunriseSunset);

/* ----------------------------------------------------------------------------
Function: ALIVE_fnc_getSunriseSunset
Description:
Gets current sunrise sunset times

Parameters:
Nil

Returns:
Array - Sunrise, Sunset times

Examples:
(begin example)
// Create instance
_times = call ALIVE_fnc_getSunriseSunset;
(end)
