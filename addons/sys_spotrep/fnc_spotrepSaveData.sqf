...
[true, "ALiVE SYS spotrep persistence save data started", "spotrepper"] call ALIVE_fnc_timer;
...
[false, "ALiVE SYS spotrep persistence save data complete","spotrepper"] call ALIVE_fnc_timer;
