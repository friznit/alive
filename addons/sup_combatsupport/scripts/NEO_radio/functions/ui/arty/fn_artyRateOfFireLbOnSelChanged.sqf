...
{
	_artyRateDelayText ctrlSetStructuredText parseText "<t color='#627057' size='0.7' font='PuristaMedium'>DELAY - 5/30s</t>";
	
	_artyRateDelaySlider ctrlSetPosition [(0.153559 * safezoneW) + safezoneX, (0.476 * safezoneH) + safezoneY, (0.098983 * safezoneW), (0.028 * safezoneH)];
