...
[" primary weapon items: %1", str primaryWeaponItems _target] call ALIVE_fnc_dump;
[" secondary weapon: %1", secondaryWeapon _target] call ALIVE_fnc_dump;
[" secondary weapon items: %1", str secondaryWeaponItems _target] call ALIVE_fnc_dump;
[" handgun: %1", handgunWeapon _target] call ALIVE_fnc_dump;
[" handgun items: %1", str handgunItems _target] call ALIVE_fnc_dump;
[" assignedItems: %1", str assignedItems _target] call ALIVE_fnc_dump;
[" uniform: %1", uniform _target] call ALIVE_fnc_dump;
[" uniformItems: %1", str uniformItems _target] call ALIVE_fnc_dump;
[" vest: %1", vest _target] call ALIVE_fnc_dump;
[" vest items: %1", str vestItems _target] call ALIVE_fnc_dump;
[" backpack: %1", backpack _target] call ALIVE_fnc_dump;
[" backpack items: %1", str backpackItems _target] call ALIVE_fnc_dump;
[" weapons: %1", str weapons _target] call ALIVE_fnc_dump;
[" magazines: %1", str magazines _target] call ALIVE_fnc_dump;
