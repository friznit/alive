...
if(isNil "ALIVE_civCommands") then {
    ...
    [ALIVE_civCommands, "suicide", ["ALIVE_fnc_cc_suicide", "managed", [0.6,0.15,0.2], [30,90]]] call ALIVE_fnc_hashSet;
    [ALIVE_civCommands, "rogue", ["ALIVE_fnc_cc_rogue", "managed", [0.6,0.15,0.2], [30,90]]] call ALIVE_fnc_hashSet;
    [ALIVE_civCommands, "randomMovement", ["ALIVE_fnc_cc_randomMovement", "managed", [0.35,0.01,0.01], [100]]] call ALIVE_fnc_hashSet;
    */

    [ALIVE_civCommands, "idle", ["ALIVE_fnc_cc_idle", "managed", [0.1,0.1,0.1], [10,30]]] call ALIVE_fnc_hashSet;
    [ALIVE_civCommands, "randomMovement", ["ALIVE_fnc_cc_randomMovement", "managed", [0.35,0.01,0.01], [100]]] call ALIVE_fnc_hashSet;
    [ALIVE_civCommands, "housework", ["ALIVE_fnc_cc_housework", "managed", [0.25,0.5,0.01], []]] call ALIVE_fnc_hashSet;
    ...
    [ALIVE_civCommands, "observe", ["ALIVE_fnc_cc_observe", "managed", [0.6,0.15,0.2], [30,90]]] call ALIVE_fnc_hashSet;
