...
spectate_events = compile preprocessFileLineNumbers ("\x\alive\addons\sys_adminactions\spect\specta_events.sqf");
...
RefreshPlayerList = compile preprocessFileLineNumbers "\x\alive\addons\sys_adminactions\spect\RefreshPlayerList.sqf";
FreeLookMovementHandler = compile preprocessFileLineNumbers "\x\alive\addons\sys_adminActions\spect\FreeLookMovementHandler.sqf";
CameraMenuHandler = compile preprocessFileLineNumbers "\x\alive\addons\sys_adminActions\spect\CameraMenuHandler.sqf";
PlayerMenuHandler = compile preprocessFileLineNumbers "\x\alive\addons\sys_adminActions\spect\PlayerMenuHandler.sqf";
