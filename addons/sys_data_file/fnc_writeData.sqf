...
SCRIPT(writeData_file);

/* ----------------------------------------------------------------------------
Function: ALIVE_fnc_writeData_file

Description:
Writes data to an external file (using JSON string)
...
// Need to check if document already exists... with file, record should have a _rev field. For SQL, just delete?
...
// From data passed create file string
_cmd = "";
_json = "";
_string = "";
